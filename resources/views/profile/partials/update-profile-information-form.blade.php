<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="place_of_birth" name="place_of_birth" type="text" class="mt-1 block w-full" :value="old('place_of_birth', $user->place_of_birth)" required />
        ...
        <div>
            ...
            <select id="sex" name="sex" class="mt-1 block w-full" required>
        ...
        <div>
            ...
            <x-text-input id="status" name="status" type="text" class="mt-1 block w-full" :value="old('status', $user->status)" required />
            <x-input-error class="mt-2" :messages="$errors->get('status')" />
        </div>
        <div>
            <x-input-label for="date_of_service" :value="__('Date of Service')" />
            <x-text-input id="date_of_service" name="date_of_service" type="date" class="mt-1 block w-full" :value="old('date_of_service', $user->date_of_service)" required />
            <x-input-error class="mt-2" :messages="$errors->get('date_of_service')" />
        </div>
        <div>
            <x-input-label for="salary" :value="__('Salary')" />
            <x-text-input id="salary" name="salary" type="number" class="mt-1 block w-full" :value="old('salary', $user->salary)" required />
